...
Formatter = (function(_super) {
  ...
  Formatter.prototype._init = function() {
    this.editor = this._module;
    this._allowedTags = ['br', 'a', 'img', 'b', 'strong', 'i', 'u', 'font', 'p', 'ul', 'ol', 'li', 'blockquote', 'pre', 'h1', 'h2', 'h3', 'h4', 'hr','center'];
...
CodeButton = (function(_super) {
  ...
  CodeButton.prototype.decorate = function($pre) {
    ...
    $pre.removeClass();
    if (lang && lang !== -1) {
      return $pre.addClass('brush:' + lang);
    }
  };
  ...
  CodePopover.prototype.render = function() {
    ...
    return this.selectEl.on('change', (function(_this) {
      return function(e) {
        ...
        if (_this.lang !== -1) {
          _this.target.addClass('brush:' + _this.lang);
